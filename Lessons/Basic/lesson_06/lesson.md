...
1. #### Sơ lược về ngôn ngữ Ruby
  ...
  puts 'Hello World'
  ```
  - Ngôn ngữ Ruby là ngôn ngữ lập trình hướng đối tượng OOP, tuy nhiên trong Ruby không hỗ trợ đa kế thừa. Mọi thứ trong Ruby là một object, mọi object là một instance của một class.
  ...
  ```
  - Ngôn ngữ Ruby có nhiều phiên bản với sự đổi mới về cú pháp, mở rộng các methods nên bạn cần lưu ý phiên bản Ruby bạn đang sử dụng.
...
```
  ...
  - Nhược điềm của Ruby:
    - So về performance thuần thì không nhanh.
    - Chưa hỗ trợ tốt cho xử lý thread, xử lý đồng thời.
    - Khá tốn ram sơ với các ngôn ngữ khác.
...
1. #### Gem là gì?
  - Gem là một thư viện trong ngôn ngữ Ruby. Trong Ruby một thư viện được gọi là Gem. Tương tự lib trong C hay Plugin trong PHP.
...
1. #### IRB (Interactive Ruby)
  ...
  ```
2. #### Cú Pháp của Ruby
  1. Tìm hiểu cú pháp đầy đủ [(Link)](https://www.tutorialspoint.com/ruby/index.htm)

  2. Các methods print ra terminal
      - `puts` - In ra một string với dấu xuống dòng
      - `printf` - In ra một string không có dấu xuống dòng

  3. Cú pháp để comment
      - Inline comments
      ```ruby
  ...
  5. Các loại dữ liệu cơ bản (Classes cơ bản)
  ...
  9. Iterator [(Link)](https://www.tutorialspoint.com/ruby/ruby_iterators.htm)
      - Các methods hỗ trợ làm việc với array/hash: `each`, `map`, `reject`, `select`...
